...
export const ICONS = Object.freeze({
  ...
  flame: svg('<path d="M12 21c-3.9 0-6.5-2.6-6.5-6.1 0-3.6 3-5.3 3.7-9.4 2.2 1.4 3.2 3.4 3.3 5.2 1-.7 1.6-1.9 1.7-3.3 2.5 2 4.3 4.6 4.3 7.5 0 3.5-2.6 6.1-6.5 6.1z" fill="currentColor" stroke-width="1.4"/>'),
